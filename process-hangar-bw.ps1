...
$src = New-Object System.Drawing.Bitmap((Join-Path $base "aviaopradireita.JPG"))
...
$outPath = Join-Path $base "jf-real-hangar-bw.jpg"
$final.Save($outPath, $encoder, $encParams)
$final.Dispose()
Write-Output "Saved: jf-real-hangar-bw.jpg ($outW x $outH)"
