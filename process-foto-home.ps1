...
$src = New-Object System.Drawing.Bitmap((Join-Path $base "fotoHome.jpg"))
$w = $src.Width; $h = $src.Height
Write-Output "source: $w x $h"

# Mirror horizontally
$src.RotateFlip([System.Drawing.RotateFlipType]::RotateNoneFlipX)
...
$outPath = Join-Path $base "jf-real-hero-home.jpg"
$final.Save($outPath, $encoder, $encParams)
$final.Dispose()
Write-Output "Saved: jf-real-hero-home.jpg ($outW x $outH)"
